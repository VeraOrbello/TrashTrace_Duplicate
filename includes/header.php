...
<header class="dashboard-header">
    ...
    <div class="header-content">
        <div class="logo">
            <img src="<?php echo $is_in_driver_subfolder ? '../' : ''; ?>assets/images/trashtrace logo green.png" alt="TrashTrace Logo" class="logo-img">
            <?php if($user_type === 'admin'): ?>
                <span class="portal-label">Admin Portal</span>
            <?php elseif($user_type === 'driver'): ?>
                <span class="portal-label">Driver Portal</span>
            <?php endif; ?>
        </div>
